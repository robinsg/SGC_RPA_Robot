...
| `send_text`                  | Sends a string of text to the terminal. Supports an optional `key` (string or list of strings) to be sent after the text with a 0.25s delay.                          | `text`, `key`                                                                                                                               |
